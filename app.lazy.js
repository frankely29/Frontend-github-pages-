(function () {
  ...
  const scriptGroups = {
    ...
    admin: [
      './admin.components.js?v=adminv4',
      './admin.actions.js?v=adminv4',
      './admin.users.js?v=adminv4',
      './admin.live.js?v=adminv4',
      './admin.reports.js?v=adminv4',
      './admin.system.js?v=adminv4',
      './admin.trips.js?v=adminv4',
      './admin.tests.js?v=adminv4',
      './admin.panel.js?v=adminv4',
    ],
  };
