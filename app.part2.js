...
(function() {
  ...
  function injectDriverProfileStyles() {
    ...
    style.textContent = `
      ...
      .driverProfileSheet{position:absolute;left:50%;transform:translate(-50%,110%);bottom:var(--driver-profile-bottom-offset, 16px);width:min(430px,calc(100vw - 16px));max-height:calc(100vh - var(--driver-profile-bottom-offset, 16px) - env(safe-area-inset-top) - 6px);background:rgba(255,255,255,.985);border-radius:24px 24px 16px 16px;box-shadow:0 -12px 30px rgba(0,0,0,.2);display:flex;flex-direction:column;overflow:hidden;transition:transform .18s ease-out;z-index:9801}
      ...
      .driverProfileBadgeRow{display:flex;align-items:center;gap:4px;margin-top:1px;min-height:22px}
      ...
      .driverProfileDailyRanks{margin-top:2px;padding-top:2px;border-top:1px dashed #dbe4ee}
